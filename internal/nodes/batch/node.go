	...
	err := reg.RegisterFactory("batch", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"mode": {
					Type:        "string",
					Description: "count (flush at N messages) or interval (flush every intervalMs)",
					Default:     "count",
					Label:       "Mode",
					Order:       1,
					Widget:      "select",
					Options:     []registry.Option{{Value: "count", Label: "Number of messages"}, {Value: "interval", Label: "Time interval"}},
				},
				"count": {
					Type:        "number",
					...
					Order:       2,
					Widget:      "number",
					VisibleWhen: &registry.Condition{Property: "mode", Values: []string{"count"}},
				},
				"intervalMs": {
					Type:        "number",
					...
					Widget:      "duration",
					Unit:        "ms",
					VisibleWhen: &registry.Condition{Property: "mode", Values: []string{"interval"}},
				},
			},
		},
