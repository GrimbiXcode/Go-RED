	...
	err := reg.RegisterFactory("http request", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				...
				"url": {
					Type:        "object",
					Description: `Request URL, e.g. {"type":"str","value":"https://example.com"}`,
				...
				"headers": {
					Type:        "object",
					Description: "Fixed request headers",
				...
				"tls": {
					Type:        "string",
					Description: "ID of an existing tls-config node (optional)",
					Default:     "",
					Label:       "TLS configuration",
					Group:       "Connection",
					Order:       6,
					Widget:      "nodeSelect",
					NodeTypes:   []string{"tls-config"},
				},
				"proxy": {
					Type:        "string",
					Description: "ID of an existing http-proxy node (optional)",
					Default:     "",
					Label:       "Proxy",
					Group:       "Connection",
					Order:       7,
					Widget:      "nodeSelect",
					NodeTypes:   []string{"http proxy"},
				},
				"insecureSkipVerify": {
					Type:        "boolean",
					Description: "Skip TLS certificate verification (ignored if tls is set); testing only",
					Default:     false,
