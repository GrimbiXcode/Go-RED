	...
	err := reg.RegisterFactory("mqtt-broker", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"url": {
					Type:        "string",
					Description: "Broker URL, e.g. tcp://localhost:1883 or ssl://localhost:8883",
					Default:     "",
					Label:       "URL",
				...
				"clientId": {
					Type:        "string",
					Description: "MQTT client ID (default: a generated unique ID)",
					Default:     "",
					Label:       "Client ID",
					Placeholder: "auto",
					Group:       "Connection",
				...
				"cleanSession": {
					Type:        "boolean",
					Description: "Start a clean MQTT session on each connect",
					Default:     true,
					Label:       "Clean session",
					Group:       "Connection",
					Order:       4,
				...
				"insecureSkipVerify": {
					Type:        "boolean",
					Description: "Skip broker certificate verification (testing only)",
					Default:     false,
					Label:       "Skip certificate verification",
					Group:       "Security",
					Order:       8,
					Widget:      "boolean",
					VisibleWhen: &registry.Condition{Property: "useTLS", Values: []string{"true"}},
				},
			},
			Required: []string{"url"},
		},
