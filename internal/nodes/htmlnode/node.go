	...
	err := reg.RegisterFactory("html", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"selector": {
					Type:        "string",
					Description: "CSS selector subset: tag, .class, #id, descendant combinator",
					Default:     "",
					Label:       "CSS selector",
				...
				"ret": {
					Type:        "string",
					Description: "html (outer markup), text (text content), or attr (an attribute value)",
					Default:     "html",
					Label:       "Return",
					Order:       2,
					Widget:      "select",
					Options:     []registry.Option{{Value: "html", Label: "HTML"}, {Value: "text", Label: "Text"}, {Value: "attr", Label: "Attribute value"}},
				},
				"attr": {
					Type:        "string",
					Description: "Attribute name to extract when ret is \"attr\"",
					Default:     "",
					Label:       "Attribute",
					Placeholder: "href",
					Order:       3,
					Widget:      "text",
					VisibleWhen: &registry.Condition{Property: "ret", Values: []string{"attr"}},
				},
			},
		},
