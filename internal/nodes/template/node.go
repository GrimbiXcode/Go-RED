	...
	err := reg.RegisterFactory("template", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"field": {
					Type:        "string",
					Description: "Message property to write the result to",
					Default:     "payload",
					Label:       "Set property",
					Placeholder: "payload",
					Order:       1,
				...
				"syntax": {
					Type:        "string",
					Description: "mustache (render placeholders) or plain (literal text)",
					Default:     "mustache",
					Label:       "Syntax",
					Order:       2,
					Widget:      "select",
					Options:     []registry.Option{{Value: "mustache", Label: "Mustache"}, {Value: "plain", Label: "Plain text"}},
				},
				"template": {
					Type:        "string",
					Description: "Template text, e.g. \"hello {{payload.name}}\"",
					Default:     "",
					Label:       "Template",
					Order:       3,
					Widget:      "code",
				...
				"output": {
					Type:        "string",
					Description: "str (leave as text) or json (parse the rendered text as JSON)",
					Default:     "str",
					Label:       "Output",
					Order:       4,
					Widget:      "select",
					Options:     []registry.Option{{Value: "str", Label: "Plain text"}, {Value: "json", Label: "Parsed JSON"}},
				},
			},
		},
