	...
	err := reg.RegisterFactory("range", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"property": {
					Type:        "object",
					Description: `Property to scale, e.g. {"type":"msg","path":"payload"}`,
				...
				"action": {
					Type:        "string",
					Description: "scale, clamp, or roll",
					Default:     "scale",
					Label:       "Action",
					Order:       2,
					Widget:      "select",
					Options:     []registry.Option{{Value: "scale", Label: "Scale"}, {Value: "clamp", Label: "Scale and limit"}, {Value: "roll", Label: "Scale and wrap"}},
				},
				"minin": {
					Type:        "number",
