	...
	err := reg.RegisterFactory("file", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"filename": {
					Type:        "object",
					Description: `Path to write, e.g. {"type":"str","value":"/tmp/out.txt"}`,
				...
				"action": {
					...
					Order:       2,
					Widget:      "select",
					Options:     []registry.Option{{Value: "append", Label: "Append to file"}, {Value: "overwrite", Label: "Overwrite file"}, {Value: "delete", Label: "Delete file"}},
				},
				"appendNewline": {
					Type:        "boolean",
					Description: "Append a newline after the written payload",
					Default:     false,
					Label:       "Append newline",
					Order:       3,
					Widget:      "boolean",
					VisibleWhen: &registry.Condition{Property: "action", Values: []string{"append"}},
				},
				"createDir": {
					Type:        "boolean",
					Description: "Create the parent directory if it doesn't exist",
					Default:     false,
					Label:       "Create directory if missing",
					Order:       4,
					Widget:      "boolean",
					VisibleWhen: &registry.Condition{Property: "action", Values: []string{"append", "overwrite"}},
				},
				"encoding": {
					Type:        "string",
					Description: "utf8 (payload written as-is) or base64 (payload is a base64 string, decoded before writing)",
					Default:     "utf8",
					Label:       "Encoding",
					Order:       5,
					Widget:      "select",
					Options:     []registry.Option{{Value: "utf8", Label: "UTF-8 text"}, {Value: "base64", Label: "Base64"}},
					VisibleWhen: &registry.Condition{Property: "action", Values: []string{"append", "overwrite"}},
				},
			},
