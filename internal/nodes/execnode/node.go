	...
	err := reg.RegisterFactory("exec", func() registry.NodeExecutor {
		...
		ConfigSchema: registry.Schema{
			Properties: map[string]registry.Property{
				"command": {
					Type:        "string",
					Description: "Executable name or path (never taken from the message)",
					Default:     "",
					Label:       "Command",
				...
				"args": {
					Type:        "array",
					Description: "Fixed extra arguments, in order",
					Default:     []interface{}{},
					Label:       "Arguments",
					Order:       2,
					Widget:      "stringList",
				...
				"appendPayload": {
					Type:        "boolean",
					Description: "Append msg.payload (string or array of strings) as trailing arguments",
					Default:     false,
					Label:       "Append msg.payload as extra argument",
					Order:       3,
					Widget:      "boolean",
				},
				"timeoutMs": {
